  ...
  return (
    <div id='know-me' className='mt-3 flex flex-col items-center py-10'>
      ...
      <div className='flex flex-wrap w-full lg:flex-wrap justify-around items-center'>
          ...
          I'm a 17 year old front-end dev, from Pakistan. I discovered my passion for coding after joining the CS society in high school. I love using my creativity to build things for the web. With hard work, self-discipline, and commitment, I became a frontend developer. What keeps me going is that I find learning new things exciting and enjoy facing challenges. Besides coding, I like building side projects because it lets me be creative and do interesting things.
          </div>
